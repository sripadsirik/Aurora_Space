...
func TestRecordsLabelPR61(t *testing.T) {
	cases := []struct {
		name  string
		count int
		noun  string
...
func TestFirstNonEmptyPR61(t *testing.T) {
	cases := []struct {
		name   string
		values []string
		want   string
...
func TestMaxTimePR61(t *testing.T) {
...
func TestFormatEventTimePR61(t *testing.T) {
...
func TestStatusForFreshnessPR61(t *testing.T) {
...
func TestSummarizeLogLinePR61(t *testing.T) {
	cases := []struct {
		name string
		line string
		want string
...
func TestLoadTrackedProcessRecordsPR61(t *testing.T) {
	dir := t.TempDir()
...
func TestBuildCelestrakRowPR61(t *testing.T) {
...
func TestBuildSpaceTrackRowPR61(t *testing.T) {
...
func TestBuildEngineRowPR61(t *testing.T) {
...
func TestBuildNoaaRowPR61(t *testing.T) {
