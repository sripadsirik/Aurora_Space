...
func TestRecordsLabelPR44(t *testing.T) {
	cases := []struct {
		name  string
		count int
		noun  string
...
func TestFirstNonEmptyPR44(t *testing.T) {
	cases := []struct {
		name   string
		values []string
		want   string
...
func TestMaxTimePR44(t *testing.T) {
...
func TestStatusForFreshnessPR44(t *testing.T) {
	live := 30 * time.Second
	stale := 5 * time.Minute
	now := time.Now()
...
func TestFormatEventTimePR44(t *testing.T) {
...
func TestSummarizeLogLinePR44(t *testing.T) {
	cases := []struct {
		name string
		line string
		want string
