...
func TestFirstNonEmptyPR57(t *testing.T) {
	tests := []struct {
		name   string
		values []string
		want   string
...
func TestMaxTimePR57(t *testing.T) {
...
func TestRecordsLabelPR57(t *testing.T) {
	tests := []struct {
		name  string
		count int
		noun  string
...
func TestFormatEventTimePR57(t *testing.T) {
	var zero time.Time
...
func TestStatusForFreshnessPR57(t *testing.T) {
	live := 2 * time.Minute
...
func TestSummarizeLogLinePR57(t *testing.T) {
	tests := []struct {
		name string
		line string
		want string
...
func TestBuildCelestrakRowPR57(t *testing.T) {
	now := time.Now()
...
func TestBuildEngineRowPR57(t *testing.T) {
	now := time.Now()
...
func TestBuildSpaceTrackRowPR57(t *testing.T) {
	now := time.Now()
...
func TestBuildNoaaRowPR57(t *testing.T) {
	now := time.Now()
