...
func TestFirstNonEmptyPR52(t *testing.T) {
	cases := []struct {
		name   string
		values []string
		want   string
...
func TestMaxTimePR52(t *testing.T) {
...
func TestStatusForFreshnessPR52(t *testing.T) {
...
func TestRecordsLabelPR52(t *testing.T) {
	cases := []struct {
		name  string
		count int
		noun  string
...
func TestFormatEventTimePR52(t *testing.T) {
...
func TestSummarizeLogLinePR52(t *testing.T) {
	cases := []struct {
		name string
		line string
		want string
