...
func TestFirstNonEmptyPR45(t *testing.T) {
	tests := []struct {
		name   string
		values []string
		want   string
...
func TestMaxTimePR45(t *testing.T) {
...
func TestRecordsLabelPR45(t *testing.T) {
	tests := []struct {
		name  string
		count int
		noun  string
...
func TestStatusForFreshnessPR45(t *testing.T) {
	live := 2 * time.Minute
...
func TestFormatEventTimePR45(t *testing.T) {
...
func TestSummarizeLogLinePR45(t *testing.T) {
	tests := []struct {
		name string
		line string
		want string
...
func TestLoadTrackedProcessRecordsPR45(t *testing.T) {
