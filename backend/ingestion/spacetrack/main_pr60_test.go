...
func TestParseCDMsValidPR60(t *testing.T) {
	body := []byte(`[
		{
			"CDM_ID": "c1",
...
func TestParseCDMsEmptyFieldsPR60(t *testing.T) {
...
func TestParseCDMsEmptyArrayPR60(t *testing.T) {
...
func TestParseCDMsInvalidJSONPR60(t *testing.T) {
