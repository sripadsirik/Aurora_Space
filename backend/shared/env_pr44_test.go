...
func TestParseDotEnvLinePR44(t *testing.T) {
	cases := []struct {
		name      string
		line      string
		wantKey   string
...
func TestLoadDotEnvMissingFileReturnsNilPR44(t *testing.T) {
...
func TestLoadDotEnvSetsUnsetVariablesPR44(t *testing.T) {
...
func TestLoadDotEnvDoesNotOverrideExistingPR44(t *testing.T) {
	path := filepath.Join(t.TempDir(), ".env")
