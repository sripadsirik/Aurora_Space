...
func TestParseDotEnvLinePR57(t *testing.T) {
	tests := []struct {
		name      string
		line      string
		wantKey   string
...
func writeTempEnvPR57(t *testing.T, contents string) string {
	t.Helper()
...
func TestLoadDotEnvSetsUnsetVariablesPR57(t *testing.T) {
	path := writeTempEnvPR57(t, "AURORA_TEST_LOADED=from_file\n# comment\nAURORA_TEST_QUOTED=\"quoted value\"\n")
...
func TestLoadDotEnvDoesNotOverrideExistingPR57(t *testing.T) {
	path := writeTempEnvPR57(t, "AURORA_TEST_PRESET=from_file\n")
...
func TestLoadDotEnvMissingFileIsNoErrorPR57(t *testing.T) {
