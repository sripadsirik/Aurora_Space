...
func TestParseDotEnvLinePR45(t *testing.T) {
	tests := []struct {
		name    string
		line    string
		wantKey string
...
func TestLoadDotEnvMissingFileIsNoErrorPR45(t *testing.T) {
...
func TestLoadDotEnvSetsUnsetVarsPR45(t *testing.T) {
	dir := t.TempDir()
...
func TestLoadDotEnvDoesNotOverrideExistingPR45(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, ".env")
